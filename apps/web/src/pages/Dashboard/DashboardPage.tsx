...
export function DashboardPage() {
  ...
  return (
    <div className="relative mx-auto w-full min-w-0 max-w-[1640px] pb-8 text-slate-200">
      ...
      <footer className="mt-5 flex flex-col gap-2 border-t border-white/[0.08] pt-4 text-xs uppercase tracking-[0.1em] text-slate-400 sm:flex-row sm:items-center sm:justify-between"><span className="flex items-center gap-2"><Server className="h-3.5 w-3.5" />Cyberium Shield telemetry fabric</span><span>Unavailable values are never estimated</span></footer>
    </div>
  );
}
